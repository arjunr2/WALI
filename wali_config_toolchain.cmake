...
set (CMAKE_CXX_FLAGS "-stdlib=libc++ ${CMAKE_C_FLAGS} -I${ROOT_DIR}/libcxx/include/c++/v1")
set (CMAKE_EXE_LINKER_FLAGS "-L${CMAKE_SYSROOT}/lib -L${WALI_LIBCXX_DIR}/lib -Wl,--shared-memory -Wl,--export-memory -Wl,--max-memory=2147483648 -Wl,--warn-unresolved-symbols")
