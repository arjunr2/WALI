...
_syscall_list: List[Syscall] = [
    impl("read", ["int fd", "void* buf", "size_t count"], Nrs(x86_64=0, arm64=63, rv64=63)),
    impl("write", ["int fd", "void* buf", "size_t count"], Nrs(x86_64=1, arm64=64, rv64=64)),
    impl("open", ["char* pathname", "int flags", "mode_t mode"], Nrs(x86_64=2)),
    impl("close", ["int fd"], Nrs(x86_64=3, arm64=57, rv64=57)),
    impl("stat", ["char* pathname", "struct stat* statbuf"], Nrs(x86_64=4)),
    impl("fstat", ["int fd", "struct stat* statbuf"], Nrs(x86_64=5, arm64=80, rv64=80)),
    impl("lstat", ["char* pathname", "struct stat* statbuf"], Nrs(x86_64=6)),
    impl("poll", ["struct pollfd* fds", "nfds_t nfds", "int timeout"], Nrs(x86_64=7)),
    impl("lseek", ["int fd", "off_t offset", "int whence"], Nrs(x86_64=8, arm64=62, rv64=62)),
    impl("mmap", ["void* addr", "size_t length", "int prot", "int flags", "int fd", "off_t offset"], Nrs(x86_64=9, arm64=222, rv64=222), unused_aliases=["mmap2"]),
    impl("mprotect", ["void* addr", "size_t len", "int prot"], Nrs(x86_64=10, arm64=226, rv64=226)),
    impl("munmap", ["void* addr", "size_t len"], Nrs(x86_64=11, arm64=215, rv64=215)),
    impl("brk", ["void* addr"], Nrs(x86_64=12, arm64=214, rv64=214)),
    impl("rt_sigaction", ["int signum", "struct sigaction* act", "struct sigaction* oldact", "size_t sigsetsize"], Nrs(x86_64=13, arm64=134, rv64=134)),
    impl("rt_sigprocmask", ["int how", "sigset_t* set", "sigset_t* oldset", "size_t sigsetsize"], Nrs(x86_64=14, arm64=135, rv64=135)),
    impl("rt_sigreturn", ["long unused"], Nrs(x86_64=15, arm64=139, rv64=139)),
    impl("ioctl", ["int fd", "int request", "char* argp"], Nrs(x86_64=16, arm64=29, rv64=29)),
    impl("pread64", ["int fd", "char* buf", "size_t count", "off_t offset"], Nrs(x86_64=17, arm64=67, rv64=67)),
    impl("pwrite64", ["int fd", "char* buf", "size_t count", "off_t offset"], Nrs(x86_64=18, arm64=68, rv64=68)),
    impl("readv", ["int fd", "struct iovec* iov", "int iovcnt"], Nrs(x86_64=19, arm64=65, rv64=65)),
    impl("writev", ["int fd", "struct iovec* iov", "int iovcnt"], Nrs(x86_64=20, arm64=66, rv64=66)),
    impl("access", ["char* pathname", "int mode"], Nrs(x86_64=21)),
    impl("pipe", ["int* pipefd"], Nrs(x86_64=22)),
    impl("select", ["int nfds", "fd_set* readfds", "fd_set* writefds", "fd_set* exceptfds", "struct timeval* timeout"], Nrs(x86_64=23)),
    impl("sched_yield", [], Nrs(x86_64=24, arm64=124, rv64=124)),
    impl("mremap", ["void* old_address", "size_t old_size", "size_t new_size", "int flags", "void* new_address"], Nrs(x86_64=25, arm64=216, rv64=216)),
    impl("msync", ["void* addr", "size_t length", "int flags"], Nrs(x86_64=26, arm64=227, rv64=227)),
    unimpl("mincore", Nrs(x86_64=27, arm64=232, rv64=232)),
    impl("madvise", ["void* addr", "size_t length", "int advice"], Nrs(x86_64=28, arm64=233, rv64=233)),
    ...
    impl("dup", ["int oldfd"], Nrs(x86_64=32, arm64=23, rv64=23)),
    impl("dup2", ["int oldfd", "int newfd"], Nrs(x86_64=33)),
    ...
    impl("socket", ["int domain", "int type", "int protocol"], Nrs(x86_64=41, arm64=198, rv64=198)),
    impl("connect", ["int sockfd", "struct sockaddr* addr", "socklen_t addrlen"], Nrs(x86_64=42, arm64=203, rv64=203)),
    impl("accept", ["int sockfd", "struct sockaddr* addr", "socklen_t* addrlen"], Nrs(x86_64=43, arm64=202, rv64=202)),
    impl("sendto", ["int sockfd", "void* buf", "size_t len", "int flags", "struct sockaddr* dest_addr", "socklen_t addrlen"], Nrs(x86_64=44, arm64=206, rv64=206)),
    impl("recvfrom", ["int sockfd", "void* buf", "size_t len", "int flags", "struct sockaddr* src_addr", "socklen_t* addrlen"], Nrs(x86_64=45, arm64=207, rv64=207)),
    impl("sendmsg", ["int sockfd", "struct msghdr* msg", "int flags"], Nrs(x86_64=46, arm64=211, rv64=211)),
    impl("recvmsg", ["int sockfd", "struct msghdr* msg", "int flags"], Nrs(x86_64=47, arm64=212, rv64=212)),
    impl("shutdown", ["int sockfd", "int how"], Nrs(x86_64=48, arm64=210, rv64=210)),
    impl("bind", ["int sockfd", "struct sockaddr* addr", "socklen_t addrlen"], Nrs(x86_64=49, arm64=200, rv64=200)),
    impl("listen", ["int sockfd", "int backlog"], Nrs(x86_64=50, arm64=201, rv64=201)),
    impl("getsockname", ["int sockfd", "struct sockaddr* addr", "socklen_t* addrlen"], Nrs(x86_64=51, arm64=204, rv64=204)),
    impl("getpeername", ["int sockfd", "struct sockaddr* addr", "socklen_t* addrlen"], Nrs(x86_64=52, arm64=205, rv64=205)),
    impl("socketpair", ["int domain", "int type", "int protocol", "int* sv"], Nrs(x86_64=53, arm64=199, rv64=199)),
    impl("setsockopt", ["int sockfd", "int level", "int optname", "void* optval", "socklen_t optlen"], Nrs(x86_64=54, arm64=208, rv64=208)),
    impl("getsockopt", ["int sockfd", "int level", "int optname", "void* optval", "socklen_t* optlen"], Nrs(x86_64=55, arm64=209, rv64=209)),
    unimpl("clone", Nrs(x86_64=56, arm64=220, rv64=220)),
    impl("fork", [], Nrs(x86_64=57)),
    unimpl("vfork", Nrs(x86_64=58)),
    impl("execve", ["char* pathname", "char** argv", "char** envp"], Nrs(x86_64=59, arm64=221, rv64=221)),
    impl("exit", ["int status"], Nrs(x86_64=60, arm64=93, rv64=93)),
    impl("wait4", ["pid_t pid", "int* wstatus", "int options", "struct rusage* rusage"], Nrs(x86_64=61, arm64=260, rv64=260)),
    impl("kill", ["pid_t pid", "int sig"], Nrs(x86_64=62, arm64=129, rv64=129)),
    impl("uname", ["struct utsname* buf"], Nrs(x86_64=63, arm64=160, rv64=160)),
    ...
    impl("fcntl", ["int fd", "int cmd", "unsigned long arg"], Nrs(x86_64=72, arm64=25, rv64=25)),
    impl("flock", ["int fd", "int operation"], Nrs(x86_64=73, arm64=32, rv64=32)),
    impl("fsync", ["int fd"], Nrs(x86_64=74, arm64=82, rv64=82)),
    impl("fdatasync", ["int fd"], Nrs(x86_64=75, arm64=83, rv64=83)),
    unimpl("truncate", Nrs(x86_64=76, arm64=45, rv64=45)),
    impl("ftruncate", ["int fd", "off_t length"], Nrs(x86_64=77, arm64=46, rv64=46)),
    # getdents is obsolete and legacy; it is aliased to getdents64 for WALI
    unimpl("getdents", Nrs(x86_64=78)),
    impl("getcwd", ["char* buf", "size_t size"], Nrs(x86_64=79, arm64=17, rv64=17)),
    impl("chdir", ["char* path"], Nrs(x86_64=80, arm64=49, rv64=49)),
    impl("fchdir", ["int fd"], Nrs(x86_64=81, arm64=50, rv64=50)),
    impl("rename", ["char* oldpath", "char* newpath"], Nrs(x86_64=82)),
    impl("mkdir", ["char* pathname", "mode_t mode"], Nrs(x86_64=83)),
    impl("rmdir", ["char* pathname"], Nrs(x86_64=84)),
    unimpl("creat", Nrs(x86_64=85)),
    impl("link", ["char* oldpath", "char* newpath"], Nrs(x86_64=86)),
    impl("unlink", ["char* pathname"], Nrs(x86_64=87)),
    impl("symlink", ["char* target", "char* linkpath"], Nrs(x86_64=88)),
    impl("readlink", ["char* pathname", "char* buf", "size_t bufsiz"], Nrs(x86_64=89)),
    impl("chmod", ["char* pathname", "mode_t mode"], Nrs(x86_64=90)),
    impl("fchmod", ["int fd", "mode_t mode"], Nrs(x86_64=91, arm64=52, rv64=52)),
    impl("chown", ["char* pathname", "uid_t owner", "gid_t group"], Nrs(x86_64=92)),
    impl("fchown", ["int fd", "uid_t owner", "gid_t group"], Nrs(x86_64=93, arm64=55, rv64=55)),
    unimpl("lchown", Nrs(x86_64=94)),
    impl("umask", ["mode_t mask"], Nrs(x86_64=95, arm64=166, rv64=166)),
    impl("gettimeofday", ["struct timeval* tv", "struct timezone* tz"], Nrs(x86_64=96, arm64=169, rv64=169)),
    impl("getrlimit", ["int resource", "struct rlimit* rlim"], Nrs(x86_64=97, arm64=163, rv64=163)),
    impl("getrusage", ["int who", "struct rusage* usage"], Nrs(x86_64=98, arm64=165, rv64=165)),
    impl("sysinfo", ["struct sysinfo* info"], Nrs(x86_64=99, arm64=179, rv64=179)),
    ...
    impl("setuid", ["uid_t uid"], Nrs(x86_64=105, arm64=146, rv64=146)),
    impl("setgid", ["gid_t gid"], Nrs(x86_64=106, arm64=144, rv64=144)),
    impl("geteuid", [], Nrs(x86_64=107, arm64=175, rv64=175)),
    impl("getegid", [], Nrs(x86_64=108, arm64=177, rv64=177)),
    impl("setpgid", ["pid_t pid", "pid_t pgid"], Nrs(x86_64=109, arm64=154, rv64=154)),
    ...
    impl("setreuid", ["uid_t ruid", "uid_t euid"], Nrs(x86_64=113, arm64=145, rv64=145)),
    impl("setregid", ["gid_t rgid", "gid_t egid"], Nrs(x86_64=114, arm64=143, rv64=143)),
    impl("getgroups", ["size_t size", "gid_t* list"], Nrs(x86_64=115, arm64=158, rv64=158)),
    impl("setgroups", ["size_t size", "gid_t* list"], Nrs(x86_64=116, arm64=159, rv64=159)),
    impl("setresuid", ["uid_t ruid", "uid_t euid", "uid_t suid"], Nrs(x86_64=117, arm64=147, rv64=147)),
    unimpl("getresuid", Nrs(x86_64=118, arm64=148, rv64=148)),
    impl("setresgid", ["gid_t rgid", "gid_t egid", "gid_t sgid"], Nrs(x86_64=119, arm64=149, rv64=149)),
    unimpl("getresgid", Nrs(x86_64=120, arm64=150, rv64=150)),
    impl("getpgid", ["pid_t pid"], Nrs(x86_64=121, arm64=155, rv64=155)),
    unimpl("setfsuid", Nrs(x86_64=122, arm64=151, rv64=151)),
    unimpl("setfsgid", Nrs(x86_64=123, arm64=152, rv64=152)),
    impl("getsid", ["pid_t pid"], Nrs(x86_64=124, arm64=156, rv64=156)),
    unimpl("capget", Nrs(x86_64=125, arm64=90, rv64=90)),
    unimpl("capset", Nrs(x86_64=126, arm64=91, rv64=91)),
    impl("rt_sigpending", ["sigset_t* set", "size_t sigsetsize"], Nrs(x86_64=127, arm64=136, rv64=136)),
    unimpl("rt_sigtimedwait", Nrs(x86_64=128, arm64=137, rv64=137)),
    unimpl("rt_sigqueueinfo", Nrs(x86_64=129, arm64=138, rv64=138)),
    impl("rt_sigsuspend", ["sigset_t* mask", "size_t sigsetsize"],Nrs(x86_64=130, arm64=133, rv64=133)),
    impl("sigaltstack", ["stack_t* ss", "stack_t* old_ss"], Nrs(x86_64=131, arm64=132, rv64=132)),
    ...
    impl("statfs", ["char* path", "struct statfs* buf"], Nrs(x86_64=137, arm64=43, rv64=43)),
    impl("fstatfs", ["int fd", "struct statfs* buf"], Nrs(x86_64=138, arm64=44, rv64=44)),
    ...
    impl("prctl", ["int option", "unsigned long arg2", "unsigned long arg3", "unsigned long arg4", "unsigned long arg5"], Nrs(x86_64=157, arm64=167, rv64=167)),
    unimpl("arch_prctl", Nrs(x86_64=158)),
    unimpl("adjtimex", Nrs(x86_64=159, arm64=171, rv64=171)),
    impl("setrlimit", ["int resource", "struct rlimit* rlim"], Nrs(x86_64=160, arm64=164, rv64=164)),
    impl("chroot", ["char* path"], Nrs(x86_64=161, arm64=51, rv64=51)),
    ...
    impl("tkill", ["int tid", "int sig"], Nrs(x86_64=200, arm64=130, rv64=130)),
    unimpl("time", Nrs(x86_64=201)),
    impl("futex", ["int* uaddr", "int futex_op", "int val", "struct timespec* timeout", "int* uaddr2", "int val3"], Nrs(x86_64=202, arm64=98, rv64=98)),
    unimpl("sched_setaffinity", Nrs(x86_64=203, arm64=122, rv64=122)),
    impl("sched_getaffinity", ["pid_t pid", "size_t cpusetsize", "cpu_set_t* mask"], Nrs(x86_64=204, arm64=123, rv64=123)),
    ...
    impl("getdents64", ["int fd", "struct dirent* dirp", "int count"], Nrs(x86_64=217, arm64=61, rv64=61), aliases=["getdents"]),
    impl("set_tid_address", ["int* tidptr"], Nrs(x86_64=218, arm64=96, rv64=96)),
    unimpl("restart_syscall", Nrs(x86_64=219, arm64=128, rv64=128)),
    unimpl("semtimedop", Nrs(x86_64=220, arm64=192, rv64=192)),
    impl("fadvise", ["int fd", "off_t offset", "off_t len", "int advice"], Nrs(x86_64=221, arm64=223, rv64=223), unused_aliases=["fadvise64"]),
    ...
    impl("clock_gettime", ["clockid_t clockid", "struct timespec* tp"], Nrs(x86_64=228, arm64=113, rv64=113)),
    impl("clock_getres", ["clockid_t clockid", "struct timespec* res"], Nrs(x86_64=229, arm64=114, rv64=114)),
    impl("clock_nanosleep", ["clockid_t clockid", "int flags", "struct timespec* request", "struct timespec* remain"], Nrs(x86_64=230, arm64=115, rv64=115)),
    impl("exit_group", ["int status"], Nrs(x86_64=231, arm64=94, rv64=94)),
    unimpl("epoll_wait", Nrs(x86_64=232)),
    impl("epoll_ctl", ["int epfd", "int op", "int fd", "struct epoll_event* event"], Nrs(x86_64=233, arm64=21, rv64=21)),
    ...
    impl("openat", ["int dirfd", "char* pathname", "int flags", "mode_t mode"], Nrs(x86_64=257, arm64=56, rv64=56)),
    impl("mkdirat", ["int dirfd", "char* pathname", "mode_t mode"], Nrs(x86_64=258, arm64=34, rv64=34)),
    unimpl("mknodat", Nrs(x86_64=259, arm64=33, rv64=33)),
    impl("fchownat", ["int dirfd", "char* pathname", "uid_t owner", "gid_t group", "int flags"], Nrs(x86_64=260, arm64=54, rv64=54)),
    unimpl("futimesat", Nrs(x86_64=261)),
    impl("newfstatat", ["int dirfd", "char* pathname", "struct stat* statbuf", "int flags"], Nrs(x86_64=262, arm64=79, rv64=79), aliases=["fstatat"]),
    impl("unlinkat", ["int dirfd", "char* pathname", "int flags"], Nrs(x86_64=263, arm64=35, rv64=35)),
    unimpl("renameat", Nrs(x86_64=264, arm64=38, rv64=38)),
    impl("linkat", ["int olddirfd", "char* oldpath", "int newdirfd", "char* newpath", "int flags"], Nrs(x86_64=265, arm64=37, rv64=37)),
    impl("symlinkat", ["char* target", "int newdirfd", "char* linkpath"], Nrs(x86_64=266, arm64=36, rv64=36)),
    impl("readlinkat", ["int dirfd", "char* pathname", "char* buf", "size_t bufsiz"], Nrs(x86_64=267, arm64=78, rv64=78)),
    impl("fchmodat", ["int dirfd", "char* pathname", "mode_t mode", "int flags"], Nrs(x86_64=268, arm64=53, rv64=53)),
    impl("faccessat", ["int dirfd", "char* pathname", "int mode", "int flags"], Nrs(x86_64=269, arm64=48, rv64=48)),
    impl("pselect6", ["int nfds", "fd_set* readfds", "fd_set* writefds", "fd_set* exceptfds", "struct timespec* timeout", "void* sigmask"], Nrs(x86_64=270, arm64=72, rv64=72)),
    impl("ppoll", ["struct pollfd* fds", "nfds_t nfds", "struct timespec* tmo_p", "sigset_t* sigmask", "size_t sigsetsize"], Nrs(x86_64=271, arm64=73, rv64=73)),
    ...
    impl("utimensat", ["int dirfd", "char* pathname", "struct timespec* times", "int flags"], Nrs(x86_64=280, arm64=88, rv64=88)),
    impl("epoll_pwait", ["int epfd", "struct epoll_event* events", "int maxevents", "int timeout", "sigset_t* sigmask", "size_t sigsetsize"], Nrs(x86_64=281, arm64=22, rv64=22)),
    unimpl("signalfd", Nrs(x86_64=282)),
    unimpl("timerfd_create", Nrs(x86_64=283, arm64=85, rv64=85)),
    impl("eventfd", ["int initval"], Nrs(x86_64=284)),
    ...
    impl("accept4", ["int sockfd", "struct sockaddr* addr", "socklen_t* addrlen", "int flags"], Nrs(x86_64=288, arm64=242, rv64=242)),
    unimpl("signalfd4", Nrs(x86_64=289, arm64=74, rv64=74)),
    impl("eventfd2", ["int initval", "int flags"], Nrs(x86_64=290, arm64=19, rv64=19)),
    impl("epoll_create1", ["int flags"], Nrs(x86_64=291, arm64=20, rv64=20)),
    impl("dup3", ["int oldfd", "int newfd", "int flags"], Nrs(x86_64=292, arm64=24, rv64=24)),
    impl("pipe2", ["int* pipefd", "int flags"], Nrs(x86_64=293, arm64=59, rv64=59)),
    ...
    impl("prlimit64", ["pid_t pid", "int resource", "struct rlimit* new_limit", "struct rlimit* old_limit"], Nrs(x86_64=302, arm64=261, rv64=261)),
    ...
    impl("renameat2", ["int olddirfd", "char* oldpath", "int newdirfd", "char* newpath", "int flags"], Nrs(x86_64=316, arm64=276, rv64=276)),
    unimpl("seccomp", Nrs(x86_64=317, arm64=277, rv64=277)),
    impl("getrandom", ["void* buf", "size_t buflen", "int flags"], Nrs(x86_64=318, arm64=278, rv64=278)),
    ...
    impl("statx", ["int dirfd", "char* pathname", "int flags", "unsigned int mask", "struct statx* statxbuf"], Nrs(x86_64=332, arm64=291, rv64=291)),
    ...
    impl("faccessat2", ["int dirfd", "char* pathname", "int mode", "int flags"], Nrs(x86_64=439, arm64=439, rv64=439)),
