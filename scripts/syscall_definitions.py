...
_syscall_list: List[Syscall] = [
    ...
    impl("gettimeofday", ["struct timeval*", "struct timezone*"], Nrs(x86_64=96, arm64=169, rv64=169)),
    ...
    impl("getdents64", ["int", "struct dirent*", "int"], Nrs(x86_64=217, arm64=61, rv64=61), aliases=["getdents"]),
